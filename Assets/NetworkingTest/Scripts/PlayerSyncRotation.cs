...
public class PlayerSyncRotation : NetworkBehaviour {
	...
	[SyncVar] private Quaternion syncRotation; //Transmits value to all clients when changes
	...
	[Command] private void CmdProvideRotationToServer(Quaternion rotation) {
		syncRotation = rotation;
	}

	//Only executed by clients
	[ClientCallback] private void TransmitRotation() {
		if (isLocalPlayer)
